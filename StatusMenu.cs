...
public class StatusMenu
{
    ...
    public static void draw(Graphics g, int x_offset, int y_offset)
    {
        ...
        g.DrawString(p.hp.ToString(), font, brush,
             x_offset + 90, y_offset + 346, new StringFormat());
        g.DrawString(p.attack.ToString(), font, brush,
             x_offset + 90, y_offset + 366, new StringFormat());
        g.DrawString(p.fspeed.ToString(), font, brush,
             x_offset + 90, y_offset + 386, new StringFormat());
        g.DrawString(p.mp.ToString(), font, brush,
             x_offset + 225, y_offset + 346, new StringFormat());
        g.DrawString(p.defense.ToString(), font, brush,
             x_offset + 225, y_offset + 366, new StringFormat());
        g.DrawString(p.fortune.ToString(), font, brush,
        ...
        if(value1 != 0)
            g.DrawString("+" + value1.ToString(), font_eq, brush_eq,
             x_offset + 110, y_offset + 366, new StringFormat());
        if (value2 != 0)
            g.DrawString("+" + value2.ToString(), font_eq, brush_eq,
             x_offset + 255, y_offset + 366, new StringFormat());
        if (value3 != 0)
            g.DrawString("+" + value3.ToString(), font_eq, brush_eq,
             x_offset + 110, y_offset + 386, new StringFormat());
        if (value4 != 0)
            g.DrawString("+" + value4.ToString(), font_eq, brush_eq,
